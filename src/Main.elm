...
init : ( Model, Cmd Msg )
init =
    ( SettingsScreen Settings.default, Random.generate RecievedRandomSeed (Random.int 0 9999999) )
            ...
            case msg of
                ...
                ClickedRestart ->
                    SettingsScreen game.settings
                        |> withCmd (Random.generate RecievedRandomSeed (Random.int 0 9999999))
            ...
            div [ id "settings-screen", class "screen" ]
                [ div [ id "settings-modal" ]
                    [ div [ id "settings-modal-header" ]
                        [ h1 [ id "settings-modal-header-title" ] [ text "Target" ]
                        , h2 [ id "settings-modal-header-team" ] [ text "brought to you by Julian's one man army" ]
                        ]
